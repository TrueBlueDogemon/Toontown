...
class DistributedClosetAI(DistributedFurnitureItemAI, InteractableAI):
    ...
    def setDNA(self, dnaString, finished, whichItem):
        ...
        if not finished:
            ...
            if whichItem & ClosetGlobals.SHIRT:
                success = av.replaceItemInClothesTopsList(testDna.topTex, testDna.topTexColor, testDna.sleeveTex,
            ...
            if whichItem & ClosetGlobals.SHORTS:
                success = av.replaceItemInClothesBottomsList(testDna.botTex, testDna.botTexColor,
    ...
    def resetMovie(self):
        taskMgr.doMethodLater(1, self.d_setMovie, 'resetMovie-%d' % self.getDoId(),
